...
class CelebaMaskHQDataset(CustomDataset):
    ...
    CLASSES = ('background', 'skin', 'brow', 'eye',  'eye_g', 'ear',  'ear_r',
        'nose', 'mouth', 'u_lip', 'l_lip', 'neck', 'neck_l', 'cloth', 'hair', 'hat')


    PALETTE = [[0, 153, 255], [102, 255, 153], [0, 204, 153],[255, 255, 102], [255, 255, 204],
               [255, 153, 0], [255, 102, 255], [102, 0, 51], [255, 204, 255], [255, 0, 102], 
               [255, 85, 0], [255, 170, 0],[255, 170, 85], [255, 0, 170],  [0, 255, 0], 
               [85, 255, 0], 
