...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--name', type=str, default='pix2pixHDBuQuanSpade2.2.3', help='name of the experiment. It decides where to store samples and models')        
        ...
        # for generator
        self.parser.add_argument('--netG', type=str, default='global', help='global|globalstack;selects model to use for netG')
        ...
        # 是否加入depth的损失
        self.parser.add_argument('--geom_loss',action='store_true', help='number of clusters for features')        
        self. parser.add_argument('--feats2Geom_path2', type=str, default='./checkpoints/pix2pixHD2Depth/100_net_G.pth',   help='path to pretrained features to depth map network')#预测线条的depth的模型 pix2pixHD
        
        self.parser.add_argument('--poolformer_loss',action='store_true', help='number of clusters for features')   
        self.parser.add_argument('--poolformer_checkpoint',type=str,default='./checkpoints/fpn_poolformer_s36_celebamaskhq_40k_simplify_random_erasing_v4/iter_40000.pth')   
        self.parser.add_argument('--poolformer_checkpoint2',type=str,default='./checkpoints/fpn_poolformer_s36_celebamaskhq_40k_simplify_random_erasing_v3/iter_40000.pth')   

        self.parser.add_argument('--global_l1loss',action='store_true', help='number of clusters for features')   
